 ...
 * on a schedule; auth is the shared cron credential (see
 * src/lib/cron/auth.ts) — either `x-cron-secret` matching
 * `AUTOMATION_CRON_SECRET` or `Authorization: Bearer <CRON_SECRET>`.
 *
